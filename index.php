    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="contact.php" class="btn btn-primary rounded-pill px-3 d-none d-lg-block">Join Us<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </nav>
        <!-- Navbar End -->
                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle flex-shrink-0" src="img/kavishka.jpg" alt="" style="width: 45px; height: 45px;">
                                    <div class="ms-3">
                                        <h6 class="text-primary mb-1">Kavishka Shehara</h6>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                ...
                                <a class="btn btn-primary py-3 px-5" href="call-to-action.php">Get Started Now<i class="fa fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="classes-item">
                                <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                    <img class="img-fluid rounded-circle" src="admin/images/<?php echo $row['image'] ?>" alt="">
                                </div>
                                <div class="bg-light rounded p-4 pt-5 mt-n5">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <span class="bg-primary text-white rounded-pill py-2 px-3" href="">$<?php echo $row['price'] ?></span>
                                    </div>
                                    <div class="row g-1">
                                        <div class="col-4">
                                        ...
                                        <div class="col-4">
                                            <div class="border-top border-3 border-warning pt-2">
                                                ...
                                                <small><?php echo $row['capacity'] ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" id="gname" name="gname" placeholder="Guardian Name" required>
                                                <label for="gname">Guardian Name</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="email" class="form-control border-0" id="gmail" name="gmail" placeholder="Guardian Email" required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="number" class="form-control border-0" id="cage" name="cage" placeholder="Child Age" required>
                    ...
                    ?>
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="team-item position-relative">
                                <img class="img-fluid rounded-circle w-75" src="admin/images/<?php echo $row['image'] ?>" alt="">
                                <div class="team-text">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link text-white-50" href="login.php">Admin</a>
